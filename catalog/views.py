...
#         "catalog:contacts"
#     )  # Здесь укажи URL для перенаправления после успешной отправки
#
#     def form_valid(self, form):
#         """
...
#             form
#         )  # Вызовем метод родителя для перенаправления на success_url
#
...
class ProductUpdateView(LoginRequiredMixin, UpdateView):  # Добавляем LoginRequiredMixin
    model = Product
    form_class = ProductForm
    template_name = "catalog/product_form.html"
    success_url = reverse_lazy("catalog:product_list")
